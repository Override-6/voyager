Summarize the conversation above for the agent that will continue it. Its durable state (OBJECTIVE.md, PLAN.md, tools/, knowledge/) is on disk and shown to it separately: do NOT restate the plan, the tool list or facts already written to knowledge/. Carry only the work in flight, thoroughly but without padding (under 2000 words in total):
